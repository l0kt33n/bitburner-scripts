export class StaticConfig {
     ...
     * @alias MaxAmt
     */
    static MaxAmount = 0.99;
    /**
     * max amt of ram to keep free at home
     */
    static HomeReserveMax = 100;
    /**
     * min amt of ram to keep free at home
     */
    static HomeReserveMin = 10;
    /**
     * decimal% of home's ram to reserve, bounded by above
     */
    static HomeReservePortion = 0.10;
    static homeReserve(homeRam) {
        try {
            return Math.min(StaticConfig.HomeReserveMax, Math.max(StaticConfig.HomeReserveMin, StaticConfig.HomeReservePortion * homeRam));
        }
        catch { }
        return 10;
    }
    static UseHacknetServers = false;
}
